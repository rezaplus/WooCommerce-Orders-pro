<div class="OP_options_menu">
    ...
    <ul id="tabs_buttons">
       ...
       <?php if(OrdersPro_License_Version == 'premium' ): ?>
       <li id="license" ><?php esc_html_e('License','OrderPro_domain'); ?></li>
       <?php endif; ?>
    </ul>
</div>
<ul class="OP_options" id="tabs_sections">
    ...
    <li class='OP_options_section' name="translations_tab"> <?php require_once 'Options/Translations.php'; ?> </li>
     <?php if(OrdersPro_License_Version == 'premium' ) require_once OrderPro_DIR_path.'/premium/pages/Options/License.php'; ?>
</ul>
